...
public class CollabouxServiceRegistration implements InitializingBean {
    ...
    @Value("${app.client.id:collaboux-kafka-service}")
    ...
    @Value("${collaboux.oauth.client.resource_ids:collaboux-access-control,collaboux-ui,collaboux-kafka-service}")
    private String resourceIds;

    @Value("${collaboux.oauth.client.redirect_uri:http://localhost:8081}")
